...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190830-stp-crime">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190830-stp-crime/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190830-stp-crime/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190830-stp-crime/",
      "url": "http://static.startribune.com/news/projects/all/20190830-stp-crime/"
    }
  }
}
```
